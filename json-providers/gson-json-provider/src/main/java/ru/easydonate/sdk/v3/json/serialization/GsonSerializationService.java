...
import ru.easydonate.sdk.v3.data.model.gson.plugin.discord.widget.DiscordWidgetPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.easydonate.custom.messages.CustomMessagesPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.easydonate.last.payments.LastPaymentsPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.easydonate.surcharge.SurchargeDiscountModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.easydonate.surcharge.SurchargeDiscountsListModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.easydonate.surcharge.SurchargePluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.vkontakte.community.widget.VKCommunityWidgetPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.vkontakte.messages.widget.VKMessagesWidgetPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.vkontakte.news.VKNewsPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.plugin.yandex.metrika.YandexMetrikaPluginSettingsModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.AdditionalFieldModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.ShopModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.coupon.CouponModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.coupon.CouponsListModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.mass.sale.MassSaleModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.mass.sale.MassSalesListModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.payment.PaymentModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.payment.PaymentsListModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.payment.SentCommandModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.payment.pending.PendingPaymentModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.product.ProductModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.product.ProductsListModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.purchase.*;
import ru.easydonate.sdk.v3.data.model.gson.shop.server.ServerModel;
import ru.easydonate.sdk.v3.data.model.gson.shop.server.ServersListModel;
import ru.easydonate.sdk.v3.json.serialization.deserializer.gson.BooleanIntDeserializer;
import ru.easydonate.sdk.v3.json.serialization.deserializer.gson.LocalDateTimeAdapter;
import ru.easydonate.sdk.v3.json.serialization.exclusion.GsonDeserializationExclusionStrategy;
import ru.easydonate.sdk.v3.json.serialization.exclusion.GsonSerializationExclusionStrategy;
import ru.easydonate.sdk.v3.response.gson.GsonErrorResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.discord.widget.GsonDiscordWidgetGetEmbedResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.discord.widget.GsonDiscordWidgetGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.custom.messages.GsonCustomMessagesGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.last.payments.GsonLastPaymentsGetPaymentsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.last.payments.GsonLastPaymentsGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.surcharge.GsonSurchargeGetDiscountResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.surcharge.GsonSurchargeGetDiscountsListResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.easydonate.surcharge.GsonSurchargeGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.vkontakte.community.widget.GsonVKCommunityWidgetGetEmbedResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.vkontakte.community.widget.GsonVKCommunityWidgetGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.vkontakte.messages.widget.GsonVKMessagesWidgetGetEmbedResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.vkontakte.messages.widget.GsonVKMessagesWidgetGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.vkontakte.news.GsonVKNewsGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.yandex.metrika.GsonYandexMetrikaGetEmbedResponse;
import ru.easydonate.sdk.v3.response.gson.plugin.yandex.metrika.GsonYandexMetrikaGetSettingsResponse;
import ru.easydonate.sdk.v3.response.gson.shop.*;
