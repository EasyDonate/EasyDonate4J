...
public abstract class JsonSerializationTestingModule extends TestingModule {
    ...
    protected static final String JSON_RESOURCE_SHOP_PATH_FORMAT = "/json/v3/shop/%s.json";
    protected static final String JSON_RESOURCE_PLUGIN_PATH_FORMAT = "/json/v3/plugin/%s/%s.json";
