...
import ru.soknight.easydonate.sdk.v1.response.PaymentCreatedResponse;
import ru.soknight.easydonate.sdk.v1.response.PaymentInfoResponse;
import ru.soknight.easydonate.sdk.v1.response.PaymentsListResponse;
import ru.soknight.easydonate.sdk.v1.response.ProductInfoResponse;
import ru.soknight.easydonate.sdk.v1.response.ProductsListResponse;
import ru.soknight.easydonate.sdk.v1.response.ServerInfoResponse;
import ru.soknight.easydonate.sdk.v1.response.ServersListResponse;
import ru.soknight.easydonate.sdk.v1.response.ShopInfoResponse;
